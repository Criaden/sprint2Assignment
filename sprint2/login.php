...
print $page->getTopSection();
		...
		if(isset($_POST["username"]) && isset($_POST["password"])){
			...
			$url = "https://cnmtsrv2.uwsp.edu/~smenz063/sprint2/JSON_Querys_Sprint2.php";
			...
			if (property_exists($resultObject,"errorMessage")) {        
				...
				$database = $resultObject[0]['userpass'];
				
				if(password_verify($_POST['password'], $database)){
					if($resultObject[0]['roleid'] == "2"){
						$_SESSION['role'] = "admin";
					} else if($resultObject[0]['roleid'] == "1"){
						$_SESSION['role'] = "user";	
					}
